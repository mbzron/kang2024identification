...
#   cols = c("blue", "red"),
#   scale = TRUE
# ) + RotatedAxis() + ggtitle("Top 5 Marker Genes") + theme(
#   plot.title = element_text(hjust = 0.5)
# ) + xlab("")

# ggsave(
#   "results/sc_marker_dotplot.pdf",
#   sc_marker_dotplot,
#   height = 7,
#   width = 9
# )
